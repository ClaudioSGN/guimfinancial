...
export function ReportsScreen() {
  ...
  const copy = language === "pt"
    ? {
        ...
        subtitle: "Entenda para onde o dinheiro está indo e como o mês se compara ao anterior.",
        income: "Receitas",
        expenses: "Despesas",
        net: "Resultado",
        savingsRate: "Taxa de poupanca",
        categoryBreakdown: "Despesas por categoria",
        categorySubtitle: "Participação das categorias no total gasto do mês.",
        categoryEmpty: "Sem despesas no periodo selecionado.",
        comparison: "Comparacao mensal",
        comparisonSubtitle: "Variação frente ao mês anterior.",
        paymentSplit: "Conta vs cartão",
        paymentSplitSubtitle: "Como as despesas foram pagas no mês.",
        fixedSplit: "Fixas vs variaveis",
        fixedSplitSubtitle: "Quanto do custo mensal ja e recorrente.",
        topExpenses: "Maiores despesas",
        topExpensesSubtitle: "As transações que mais pesaram no mês.",
        noData: "Sem dados suficientes para este mês.",
